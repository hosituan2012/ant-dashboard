...
/**
 * Api services for the `Plan` model.
 */
@Injectable()
export class PlanApi extends BaseLoopBackApi {
   ...
   *  - `status` – `{string}` - 
   */
  public updatebyId(data: any = {}, req: any = {}, res: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Plans/updatebyId";
    let _routeParams: any = {};
