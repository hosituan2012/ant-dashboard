...
export class AccountApi extends BaseLoopBackApi {
   ...
   * @param {any} id Account id
   *
   * @param {any} fk Foreign key for channels
   *
   * @returns {object} An empty reference that will be
   *   populated with the actual data once the response is returned
   *   from the server.
   ...
   * </em>
   */
  public findByIdChannels(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/channels/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
   ...
   * This method returns no data.
   */
  public destroyByIdChannels(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/channels/:fk";
    let _routeParams: any = {
   ...
   * </em>
   */
  public updateByIdChannels(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/channels/:fk";
    let _routeParams: any = {
   ...
   * @param {any} id Account id
   *
   * @param {any} fk Foreign key for plans
   *
   * @returns {object} An empty reference that will be
   *   populated with the actual data once the response is returned
   *   from the server.
   ...
   * </em>
   */
  public findByIdPlans(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/plans/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
   ...
   * This method returns no data.
   */
  public destroyByIdPlans(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/plans/:fk";
    let _routeParams: any = {
   ...
   * </em>
   */
  public updateByIdPlans(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/plans/:fk";
    let _routeParams: any = {
  ...
  /**
   * Add a related item by id for plans.
   *
   * @param {any} id Account id
   *
   * @param {any} fk Foreign key for plans
   ...
   * </em>
   */
  public linkPlans(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/plans/rel/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * Remove the plans relation to an item by id.
   *
   * @param {any} id Account id
   *
   * @param {any} fk Foreign key for plans
   ...
   * This method returns no data.
   */
  public unlinkPlans(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/plans/rel/:fk";
    let _routeParams: any = {
  ...
  /**
   * Check the existence of plans relation to an item by id.
   *
   * @param {any} id Account id
   *
   * @param {any} fk Foreign key for plans
   ...
   * </em>
   */
  public existsPlans(id: any, fk: any, customHeaders?: Function): Observable<any> {
   ...
   * </em>
   */
  public getChannels(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/channels";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public createChannels(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/channels";
    let _routeParams: any = {
   ...
   * This method returns no data.
   */
  public deleteChannels(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/channels";
    let _routeParams: any = {
   ...
   *  - `count` – `{number}` - 
   */
  public countChannels(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/channels/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public getPlans(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/plans";
    let _routeParams: any = {
   ...
   * </em>
   */
  public createPlans(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/plans";
    let _routeParams: any = {
   ...
   * This method returns no data.
   */
  public deletePlans(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/plans";
    let _routeParams: any = {
   ...
   *  - `count` – `{number}` - 
   */
  public countPlans(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/plans/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public createManyChannels(id: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/channels";
    let _routeParams: any = {
   ...
   * </em>
   */
  public createManyPlans(id: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/plans";
    let _routeParams: any = {
